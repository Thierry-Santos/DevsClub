...
export const ButtonOutside = props => {
  return (
    <TouchableOpacity style={[styles.outsideButton]} {...props}>
...
export const InputBasic = props => {
  return (
    <View style={[styles.inputBasic, styles.simpleShadow]}>
      <TextInput style={[styles.inputBasicText]} {...props}>
        {props.text}
      </TextInput>
    </View>
  );
...
export const InputOutline = props => {
  return (
    <View style={styles.inputOutline}>
      <TextInput style={[styles.inputOutlineText]} {...props}>
        {props.text}
      </TextInput>
    </View>
  );
...
export const InputIcon = props => {
  return (
    <View style={styles.inputIcon}>
      <IconsMCI name={props.name} style={styles.iconInput} />
      <TextInput style={[styles.inputIconText]} {...props}>
        {props.text}
      </TextInput>
    </View>
  );
