...
export const isSigned = () => {
  //recuperar os dados do async store para ver se está logado;
};
 ...
 * @constructor
 */
export const PaddingSize = (key, value) => {
  let percentage;
 ...
 * @constructor
 */
export const ScreenSize = (key, value) => {
  let percentage;
 ...
 * @constructor
 */
export const FontScreenSize = value => {
  let percentage;
